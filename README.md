...
| Dense ASPP                                                                | -                                                                                                                                   | ``dense_aspp``     |
| Attention to Scale: Scale-aware Semantic Image Segmentation               | -                                                                                                                                   | ``scale_aware``    |
| DenseCRF                                                                  | -                                                                                                                                   | ``densecrf``       |
...
| Learning a Discriminative Feature Network for Semantic Segmentation (DFN) |                                                                                                                                     | ``dfn``            |
| RefineNet                                                                 |                                                                                                                                     | ``refinenet``      |
