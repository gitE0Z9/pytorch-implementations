...
class Ssd(nn.Module):
    def __init__(
        ...
        self.head1 = RegHead(512, num_classes + 1, 4)
        self.head2 = RegHead(1024, num_classes + 1, 6)
        self.head3 = RegHead(512, num_classes + 1, 6)
        self.head4 = RegHead(256, num_classes + 1, 6)
        self.head5 = RegHead(256, num_classes + 1, 4)
        self.head6 = RegHead(256, num_classes + 1, 4)
    ...
    def forward(self, x: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        conf_list = torch.cat(conf_list, 1).view(x.size(0), -1, self.num_classes + 1)
