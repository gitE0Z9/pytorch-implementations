...
struct Vocab : torch::CustomClassHolder {
  ...
  explicit Vocab(StringList tokens, const c10::optional<int64_t>& default_index);
...
typedef std::tuple<std::string, std::vector<int64_t>, std::vector<std::string>, std::vector<torch::Tensor>>
    VocabStates;
