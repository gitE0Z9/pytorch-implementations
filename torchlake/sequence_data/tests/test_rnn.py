...
class TestNetwork:
    def test_rnn_cell_forward_shape(self):
    ...
    def test_rnn_layer_forward_shape(self, h: torch.Tensor | None):
...
class TestModel:
    ...
    def test_rnn_discriminator_forward_shape(
        self,
        name: str,
        label_size: int,
    ...
    def test_rnn_generator_forward_shape_during_train(
        self,
        num_layers: int,
        bidirectional: bool,
    ) -> None:
    ...
    def test_rnn_generator_forward_shape_during_predict(
        self,
        num_layers: int,
        bidirectional: bool,
        topk: int,
